...
@testable import ZIPFoundation
    ...
    extension ZIPFoundationTests {
        func testArchiveAddUncompressedEntryProgress() {
            ...
            let cancel = keyValueObservingExpectation(for: progress, keyPath: #keyPath(Progress.fractionCompleted),
                                                      handler: handler)
        ...
        func testZipItemProgress() {
            ...
            let fileExpectation = keyValueObservingExpectation(for: fileProgress,
            ...
            let directoryExpectation = keyValueObservingExpectation(for: directoryProgress,
                                                                    keyPath: #keyPath(Progress.fractionCompleted),
                                                                    expectedValue: 1.0)
            testQueue.async {
                do {
        ...
        func testUnzipItemProgress() {
            ...
            let expectation = keyValueObservingExpectation(for: progress,
                                                           keyPath: #keyPath(Progress.fractionCompleted),
                                                           expectedValue: 1.0)
